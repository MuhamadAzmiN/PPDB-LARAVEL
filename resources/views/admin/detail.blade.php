<x-admin-layout :title="$title">
    @if($user->keterangan_daftar == true)
    ...
    <div class="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
        ...
        <div class="px-6 py-4">
            <h1 class="text-xl font-semibold text-gray-800 dark:text-white">{{ $user->name }}</h1>

            <p class="py-2 text-gray-700 dark:text-gray-400">{{ $user->daftarId->jurusan }}</p>
            ...
            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                ...
                <h1 class="px-2 text-sm">{{ $user->daftarId->asal_sekolah }}</h1>
            </div>
            ...
            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                ...
                <h1 class="px-2 text-sm">{{ $user->daftarId->tinggal }}</h1>
            </div>
